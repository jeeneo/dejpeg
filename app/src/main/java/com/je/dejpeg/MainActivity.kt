...
class MainActivity : AppCompatActivity() {
    ...
    private fun copyAndLoadModel(modelUri: Uri) = dialogManager.copyAndLoadModel(modelUri, ::promptModelSelection)
    private fun showErrorDialog(message: String): Unit = dialogManager.showErrorDialog(message, ::promptModelSelection)
