...
@Composable fun ChunkDialog(chunk: Int, overlap: Int, onChunkChange: (Int) -> Unit, onOverlapChange: (Int) -> Unit, onDismiss: () -> Unit) {
    ...
    AlertDialog(onDismissRequest = onDismiss, title = { Text(stringResource(R.string.chunk_settings)) },
        text = { Column { SliderSetting(stringResource(R.string.chunk_size), chunkSize, 256f..2048f, 7) { newValue -> haptic.light(); chunkSize = newValue.toInt() }; Spacer(modifier = Modifier.height(16.dp)); SliderSetting(stringResource(R.string.overlap_size), overlapSize, 16f..256f, 14) { newValue -> haptic.light(); overlapSize = newValue.toInt() }; Spacer(modifier = Modifier.height(16.dp)); Text(stringResource(R.string.note_chunk_overlap), style = MaterialTheme.typography.bodySmall) } },
